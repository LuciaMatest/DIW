                ...
                <tr>
                    ...
                    try {
                        ...
                        while ($row = $resultado->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            if (esAdmin()) {
                                echo "<td>";
                                echo '<a href="../Funciones/modificarBD.php?opcion=elimina_albaran&clave=' . $row['id_albaran'] . '" style="color: #be901b;"> 
                                ...
                                echo "</td>";
                                echo "<td>";
                                echo '<a href="../Funciones/modificarBD.php?opcion=modifica_albaran&clave=' . $row['id_albaran'] . '" style="color: #be901b;"> 
