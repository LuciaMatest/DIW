                ...
                <tr>
                    ...
                    try {
                        ...
                        while ($row = $resultado->fetch(PDO::FETCH_ASSOC)) {
                            echo '<tr>';
                            echo '<td scope="row">' . $row['cod_producto'] . '</td>';
                            ...
                            <div>
                              ...
                              <a href="../Funciones/modificarBD.php?opcion=añadir_stock" style="color: #be901b;"> 
                          ...
                          ';
                            ...
                            echo '<td>';
                            if (esAdmin()) {
                                echo '<a  href="../Funciones/modificarBD.php?opcion=modifica_productos&clave=' . $row['cod_producto'] . '" style="color: #be901b;"> 
