                ...
                <tr>
                    ...
                    try {
                        ...
                        while ($row = $resultado->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            if (esAdmin()) {
                                echo "<td>";
                                echo '<a href="../Funciones/modificarBD.php?opcion=elimina_venta&clave=' . $row['id_ventas'] . '" style="color: #be901b;"> 
                                ...
                                echo "</td>";
                                echo "<td>";
                                echo '<a  href="../Funciones/modificarBD.php?opcion=modifica_ventas&clave=' . $row['id_ventas'] . '" style="color: #be901b;"> 
