        ...
        <div class="mx-2">
            <div class="d-flex bd-highlight mb-1 align-items-center justify-content-space-between">
                ...
                <div class="p-0 p-sm-0 p-md-2">
                    <a href="carrito.php" type="button" class="btn boton px-1 d-none d-sm-none d-md-block">
                ...
                <div class="p-0 p-sm-0 p-md-2">
                    <a href="logout.php" type="button" class="btn boton px-1 d-none d-sm-none d-md-block">
                            ...
                            <div class="card-body pt-4">
                                <form action="./perfil.php" method="post">
                                    <div class="mb-4 px-2">
                                        ...
                                        <input type="text" class="form-control" name="user" id="user" readonly value="<?php
                                                                                                                        echo $_SESSION["user"];
                                                                                                                        ?>">
                                        <?
                                    ...
                                    <div class="mb-4 px-2">
                                        ...
                                        <input type="email" class="form-control" name="email" id="idEmail" value="<?
                                                                                                                    echo $_SESSION["email"];
                                                                                                                    ?>">
                                        <?
                                        //comprobar que no este vacio y valido, si lo está pongo un error
                                    ...
                                    <div class="mb-4 px-2">
                                        ...
                                        <input type="text" class="form-control" name="fecha" id="fecha" placeholder="dd/mm/aaaa" value="<?
                                                                                                                                        echo $_SESSION["fecha"];
                                                                                                                                        ?>">
                                        <?
