...
insert into productos (cod_producto, imagen_alta, imagen_baja, nombre, descripcion, precio, stock) values ('1117','./alta/1-1.png', './baja/1-baja.png', 'Tahe Botanic','Mascarilla Aceite de Árgan, Aceite de Amapola y Aceite de Palo de Rosa 700 ml','21.80','7');
insert into productos (cod_producto, imagen_alta, imagen_baja, nombre, descripcion, precio, stock) values ('2596','./alta/2-2.png', './baja/2-baja.png', 'Tahe Natural Hair','Champu Dermorelax Essence 1000 ml','19.95','10');
insert into productos (cod_producto, imagen_alta, imagen_baja, nombre, descripcion, precio, stock) values ('3030','./alta/3-3.png', './baja/3-baja.png', 'Postquam','Champú de hierbas 1000 ml','6.90','4');
insert into productos (cod_producto, imagen_alta, imagen_baja, nombre, descripcion, precio, stock) values ('3152','./alta/4-4.png', './baja/4-baja.png', 'Crawford','Champú nutrición 1000 ml','10.61','12');
insert into productos (cod_producto, imagen_alta, imagen_baja, nombre, descripcion, precio, stock) values ('3319','./alta/5-5.png', './baja/5-baja.png', 'Revlon','Champú Micellar Equave hidratante con queratina 250 ml','13.81','6');
insert into productos (cod_producto, imagen_alta, imagen_baja, nombre, descripcion, precio, stock) values ('4497','./alta/6-6.png', './baja/6-baja.png', 'Postquam','Emulsión Suavizante Cabellos Teñidos 1000 ml','8.90','2');
